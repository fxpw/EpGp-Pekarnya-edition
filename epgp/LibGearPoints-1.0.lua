...
local EQUIPSLOT_MULTIPLIER_1 = {
  ...
  INVTYPE_WEAPONOFFHAND = -200,
  INVTYPE_HOLDABLE = -200,
  INVTYPE_RANGED = -200,
  INVTYPE_RANGEDRIGHT = -200,
  INVTYPE_THROWN = -200,
  INVTYPE_RELIC = -200,
  -- Hack for Tier 9 25M heroic tokens.
  INVTYPE_CUSTOM_MULTISLOT_TIER = -200,
}
...
function lib:GetValue(item)
  ...
  local high = math.floor(slot_multiplier1)
  local low = slot_multiplier2 and math.floor(slot_multiplier2) or nil
